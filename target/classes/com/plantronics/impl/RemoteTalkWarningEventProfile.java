...
import com.plantronics.SoundEvent;
import com.plantronics.SoundEventProfile;
 ...
 */
public class RemoteTalkWarningEventProfile implements SoundEventProfile {
    ...
    public SoundEvent generateSoundEvent(long timeBetweenEvents) throws Exception {
        ...
        int farEndPercent = random.nextInt((80 - 75) + 1) + 75; // range [75-80]%
        int nearEndPercent = random.nextInt(15); // range [0-10]%
