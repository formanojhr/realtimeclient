...
public class DonOnOffPubNubSubscribeTest {
    private static final Logger log = LoggerFactory.getLogger(DonOnOffPubNubSubscribeTest.class);
        ...
        SubscribeCallback pnCallback = new SubscribeCallback() {
            ...
            public void message(PubNub pubnub, PNMessageResult message) {
                ...
                if(receivedMessage == true){
                    ...
                    Assert.assertEquals(eventType,"HS_STATE_CHANGE_DON");
                    if(eventType.equals("HS_STATE_CHANGE_DON")) {
                        verifiedMsg = true;
                    }
                }
