...
public class QDPubNubSubscribeTest {
    private static final Logger log = LoggerFactory.getLogger(QDPubNubSubscribeTest.class);
             ...
             System.out.println ("Successfully getting messages from channel:  " + message.getChannel());
                ...
                if(receivedMessage == true){
                   ...
                   // validateMessage(msg);
                    ...
                    if(eventType.equals("isConnected")) {
                        verifiedMsg = true;
                    }
                }
